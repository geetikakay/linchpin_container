...
RUN wget https://copr-be.cloud.fedoraproject.org/results/@pki/10.5/epel-7-x86_64/00760967-test-pki-modules/test-pki-modules-0.1-1.noarch.rpm --no-check-certificate
